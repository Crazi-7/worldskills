            ...
            <form class="needs-validation" novalidate action="" method="post"> @csrf
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control @if ($errors->has('title')) is-invalid @endif" id="inputTitle" name="title" placeholder="" value="{{$session->title}}">
                        @if ($errors->has('title'))
                            <div class="invalid-feedback">
                                {{$errors->first('title')}}
                            </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control @if ($errors->has('speaker')) is-invalid @endif" id="inputSpeaker" name="speaker" placeholder="" value="{{$session->speaker}}">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <select class="form-control @if ($errors->has('room')) is-invalid @endif" id="selectRoom" name="room">
                            ...
                            <option @if ($room->id == $session->room_id) selected @endif value="{{$room->id}}">{{$room->name}}</option> 
                            @endforeach
                        </select>
                        @if ($errors->has('room'))
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="number" class="form-control @if ($errors->has('cost')) is-invalid @endif" id="inputCost" name="cost" placeholder="" value="{{$session->cost}}">
                        @if ($errors->has('cost'))
                            <div class="invalid-feedback">
                                {{$errors->first('cost')}}
                            </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @if ($errors->has('description')) is-invalid @endif" id="textareaDescription" name="description" placeholder="" rows="5">{{$session->description}}</textarea>
